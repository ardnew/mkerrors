...
Given a Go package "bar" at local directory path "/foo/bar", create a new empty
Go source file named "errors.go" that contains only the following:
...
"errors.go" with elaborated definitions:
...
Feel free to modify the original comment block containing the error identifiers.
Running "go generate" a subsequent time will reflect your changes accordingly 
wirhout any unnecessary duplication or outdated content.
